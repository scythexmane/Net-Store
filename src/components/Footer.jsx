      ...
      <div className="max-w-[1440px] mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mb-2">Manzil: Toshkent sh</p>
            <p className="text-sm text-gray-400 mb-2">qwertyui@gmail.com</p>
            <p className="text-sm text-gray-400">+9989917777777</p>
          </div>

          {/* Колонка 3: Haqimizda */}
          <div>
            <h3 className="text-xl font-bold mb-4">Haqimizda</h3>
            <p className="text-sm text-gray-400">
              Maxfiylik siyosati va shaxsiy ma'lumotlarni himoya qilish<br />
          ...
          <div>
            <h3 className="text-xl font-bold mb-4">Savol berish</h3>
            <form>
              <input
                type="text"
                placeholder="Ismingiz"
                className="w-full bg-gray-800 text-white text-sm py-2 px-4 rounded mb-4 focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <input
                type="text"
